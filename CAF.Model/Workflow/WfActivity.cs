...
namespace CAF.Model
{
	...
	{   
        ...
        const string QUERY_INSERT="INSERT INTO Sys_WfActivities (Id, WfProcessId, Name, Type, Post, Statuse, CreatedDate, ChangedDate, Note) VALUES (@Id, @WfProcessId, @Name, @Type, @Post, @Statuse, @CreatedDate, @ChangedDate, @Note)";
