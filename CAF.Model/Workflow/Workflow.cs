...
namespace CAF.Model
{
    ...
    public partial class Workflow
    {
        ...
        public static void UpdateWorkflow(string document)
        {
            ...
            workflow.WorkflowActivitys.Each(w => w.MarkDelete());
            workflow.WorkflowRules.Each(w => w.MarkDelete());

            //活动处理
            var newActivities = new WorkflowActivityList();
            xele.Descendants("Activity").Each(r =>
                {
            ...
            workflow.WorkflowActivitys.Where(a => activityDataSet2.Contains(a.Id)).Each(a => a.MarkDelete());
            workflow.WorkflowActivitys.Where(a => activityDataSet1.Contains(a.Id)).Each(a =>
            ...
            workflow.WorkflowRules.Where(a => ruleDataSet2.Contains(a.Id)).Each(a => a.MarkDelete());
            workflow.WorkflowRules.Where(a => ruleDataSet1.Contains(a.Id)).Each(a =>
