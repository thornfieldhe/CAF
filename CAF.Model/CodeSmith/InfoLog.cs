...
namespace CAF.Model
{
    ...
    public partial class InfoLog : BaseEntity<InfoLog>
    {
        ...
        const string QUERY_GETBYID = "SELECT Top 1 * FROM Sys_InfoLog WHERE Id = @Id  AND Status!=-1";
        const string QUERY_GETAll = "SELECT * FROM Sys_InfoLog WHERE  Status!=-1";
        const string QUERY_DELETE = "UPDATE Sys_InfoLog SET Status=-1 WHERE Id = @Id AND  Status!=-1";
        const string QUERY_EXISTS = "SELECT Count(*) FROM Sys_InfoLog WHERE Id = @Id";
        const string QUERY_INSERT = "INSERT INTO Sys_InfoLog (Id, LogTime, UserName, Page, Action) VALUES (@Id, @LogTime, @UserName, @Page, @Action)";
        const string QUERY_UPDATE = "UPDATE Sys_InfoLog SET {0} WHERE  Id = @Id";
    ...
    public class InfoLogList : CollectionBase<InfoLogList, InfoLog>
    {
        ...
        protected const string tableName = "Sys_InfoLog";
