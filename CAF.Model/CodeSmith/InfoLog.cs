...
namespace CAF.Model
{
	...
	{   
        ...
        const string QUERY_INSERT="INSERT INTO Sys_InfoLogs (Id, UserName, Page, Action, ChangedDate, CreatedDate, Status) VALUES (@Id, @UserName, @Page, @Action, @ChangedDate, @CreatedDate, @Status)";
