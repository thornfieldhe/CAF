...
namespace CAF.Model
{
    ...
    public partial class LoginLog : BaseEntity<LoginLog>
    {
        ...
        const string QUERY_GETBYID = "SELECT Top 1 * FROM Sys_LoginLog WHERE Id = @Id  AND Status!=-1";
        const string QUERY_GETAll = "SELECT * FROM Sys_LoginLog WHERE  Status!=-1";
        const string QUERY_DELETE = "UPDATE Sys_LoginLog SET Status=-1 WHERE Id = @Id AND  Status!=-1";
        const string QUERY_EXISTS = "SELECT Count(*) FROM Sys_LoginLog WHERE Id = @Id";
        const string QUERY_INSERT = "INSERT INTO Sys_LoginLog (Id, LogTime, UserName, Ip, IsLogin) VALUES (@Id, @LogTime, @UserName, @Ip, @IsLogin)";
        const string QUERY_UPDATE = "UPDATE Sys_LoginLog SET {0} WHERE  Id = @Id";
    ...
    public class LoginLogList : CollectionBase<LoginLogList, LoginLog>
    {
        ...
        protected const string tableName = "Sys_LoginLog";
