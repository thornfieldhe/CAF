...
namespace CAF.Model
{
    ...
    {
        private UserSetting() : this(Guid.NewGuid()) { }

        public UserSetting(Guid id)
            : base(id)
        {
            base.MarkNew();
        }
        ...
        public User User
        {
            get { return User.Get(this.UserId); }
        }
    ...
    public class UserSettingList : CollectionBase<UserSettingList, UserSetting>
    {
        ...
        public static UserSettingList Query(Object dynamicObj, string query = " AND 1=1")
        {
            using (IDbConnection conn = SqlService.Instance.Connection)
            {
