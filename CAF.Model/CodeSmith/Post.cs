...
namespace CAF.Model
{
	...
	{   
        ...
        const string QUERY_INSERT="INSERT INTO Sys_Posts ([Id], [Name], [CreatedDate], [ChangedDate], [Status], [Note], [Vesion]) VALUES (@Id, @Name, @CreatedDate, @ChangedDate, @Status, @Note, @Vesion)";
