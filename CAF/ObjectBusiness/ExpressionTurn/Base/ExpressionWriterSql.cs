...
namespace CAF.CAFExpression
{
    ...
    internal class ExpressionWriterSql : ExpressionVisitor
    {
        ...
        public int AiOrderTime { get; set; }

        public int AiWhereTime { get; set; }
        ...
        protected void Write(string text)
        {
            ...
            {
                case ExpSqlType.aiOrder:
                    this.aiOrdeRsult = this.aiOrdeRsult + text; break;
                case ExpSqlType.aiWhere:
                    this.aiWhereResult = this.aiWhereResult + text; break;
            }
        ...
        {
            this.Write("(");
            switch (b.NodeType) { case ExpressionType.Power:
                    this.Write("POWER(");
        ...
        protected override Expression VisitMethodCall(MethodCallExpression m)
        {
            ...
            switch (bizname)
            {
                case "orderbydescending":
                case "thenbydescending":
                    this.aiOrdeRsult = this.aiOrdeRsult + " Desc"; break;
        ...
        protected override NewExpression VisitNew(NewExpression nex)
        {
            ...
            switch (nex.Arguments.Count) { case 3:
