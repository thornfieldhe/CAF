...
namespace CAF.FS.Core.Client.SqLite
{
    public class SqlBuilder : Common.SqlBuilder
    {
        ...
        public override Queue ToEntity()
        {
            ...
            this.Queue.Sql.AppendFormat("SELECT {0} FROM {1} {2} {3} LIMIT 0,1", strSelectSql, this.QueueManger.DbProvider.KeywordAegis(this.Queue.Name), strWhereSql, strOrderBySql);
            return this.Queue;
        }
        ...
        public override Queue InsertIdentity<TEntity>(TEntity entity)
        {
            ...
            this.Queue.Sql.AppendFormat(";SELECT last_insert_rowid();");
            return this.Queue;
        }
    }
}
