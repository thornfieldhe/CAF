...
namespace CAF.FS.Core.Infrastructure
{
    ...
    public abstract class BaseContext : IDisposable
    {
        ...
        {
            this.ContextMap = CacheManger.GetContextMap(this.GetType());
            this.DataBase = new DbExecutor(this.ContextMap.ContextProperty.ConnStr, this.ContextMap.ContextProperty.DataType, this.ContextMap.ContextProperty.CommandTimeout);
        }
        ...
        {
            this.DataBase = new DbExecutor(connectionString, dbType, commandTimeout);
            this.ContextMap = CacheManger.GetContextMap(this.GetType());
        }
