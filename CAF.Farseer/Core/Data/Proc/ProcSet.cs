...
namespace FS.Core.Data.Proc
{
    ...
    public sealed class ProcSet<TEntity> where TEntity : class, new()
    {
        ...
        /// 数据库上下文
        /// </summary>
        private readonly BaseProcContext _context;
        ...
        public ProcSet(BaseProcContext context, PropertyInfo pInfo) : this(context, pInfo.Name) { }
        ...
        public ProcSet(BaseProcContext context, string propertyName)
        {
            _context = context;
            _map = typeof(TEntity);
