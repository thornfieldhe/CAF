...
namespace FS.Core.Data.Proc
{
    ...
    /// 多张存储过程上下文
    /// </summary>
    public class BaseProcContext : BaseContext
    {
        /// <summary>
        /// 使用DB特性设置数据库信息
        /// </summary>
        ...
        protected BaseProcContext(int dbIndex) : base(dbIndex) { InstanceProperty(); }
        ...
        protected BaseProcContext(string connectionString, DataBaseType dbType = DataBaseType.SqlServer, int commandTimeout = 30) : base(connectionString, dbType, commandTimeout) { InstanceProperty(); }
