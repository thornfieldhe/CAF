...
namespace FS.Core.Data.View
{
    ...
    public sealed class ViewSet<TEntity> : DbReadSet<ViewSet<TEntity>, TEntity> where TEntity : class, new()
    {
        ...
        /// 数据库上下文
        /// </summary>
        internal readonly BaseViewContext _context;
        ...
        public ViewSet(BaseViewContext context, PropertyInfo pInfo) : this(context, pInfo.Name) { }
        /// <summary>
        /// 使用属性名称的创建
        /// </summary>
        /// <param name="context">上下文</param>
        /// <param name="propertyName">属性名称</param>
        public ViewSet(BaseViewContext context, string propertyName)
        {
            _context = context;
