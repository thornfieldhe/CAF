...
namespace FS.Core.Data.View
{
    ...
    /// 多张视图上下文
    /// </summary>
    public class BaseViewContext : BaseContext
    {
        /// <summary>
        /// 使用DB特性设置数据库信息
        /// </summary>
        ...
        protected BaseViewContext(int dbIndex) : base(dbIndex) { InstanceProperty(); }
        ...
        protected BaseViewContext(string connectionString, DataBaseType dbType = DataBaseType.SqlServer, int commandTimeout = 30) : base(connectionString, dbType, commandTimeout) { InstanceProperty(); }
