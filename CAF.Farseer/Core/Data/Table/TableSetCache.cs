...
namespace FS.Core.Data.Table
{
    ...
    public class TableSetCache<TEntity> where TEntity : class, new()
    {
        ...
        public TableSetCache(BaseTableContext context, PropertyInfo pInfo) : this(context, pInfo.Name) { }
        ...
        public TableSetCache(BaseTableContext context, string propertyName)
        {
