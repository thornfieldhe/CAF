...
namespace FS.Core.Data.Table
{
    ...
    public class TableSet<TEntity> : DbWriteSet<TableSet<TEntity>, TEntity> where TEntity : class, new()
    {
        ...
        /// 数据库上下文
        /// </summary>
        internal readonly BaseTableContext _context;
        ...
        public TableSet(BaseTableContext context, PropertyInfo pInfo) : this(context, pInfo.Name) { }
        /// <summary>
        /// 使用属性名称的创建
        /// </summary>
        /// <param name="context">上下文</param>
        /// <param name="propertyName">属性名称</param>
        public TableSet(BaseTableContext context, string propertyName)
        {
            _context = context;
