...
namespace FS.Core.Data.Table
{
    ...
    /// 多张表上下文
    /// </summary>
    public class BaseTableContext : BaseContext
    {
        /// <summary>
        /// 使用DB特性设置数据库信息
        /// </summary>
        public BaseTableContext()
        {
            InstanceProperty();
        }
        ...
        protected BaseTableContext(int dbIndex) : base(dbIndex) { InstanceProperty(); }
        ...
        protected BaseTableContext(string connectionString, DataBaseType dbType = DataBaseType.SqlServer, int commandTimeout = 30) : base(connectionString, dbType, commandTimeout) { InstanceProperty(); }
